...
const portNum = 3001; // Note: this must be unique on the server this app is hosted on
const maxNumOfRooms = 8;
const maxPlayers = 7;
const minPlayers = 3;
const useDiscard = true;
var generalDeck = "d.csv";
...
var columnNum = 0;
var rowNum = 0;
fs.createReadStream('exampleRelations/cardFiles/'+generalDeck)
